...
-   `paper` contains the files used to generate the paper, including the datasheet document, Quarto document and reference bibliography file, as well as the PDF of the paper and the datasheet. 
