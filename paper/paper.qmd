...
combined_trigram <- read_csv(here::here("data/analysis_data/combined_trigram.csv"))
combined_bigram <- read_csv(here::here("data/analysis_data/combined_bigram.csv"))
...
We use [@flow] [@pathology] [@resampling] and @rohan.
...
#| message: false
#| warning: false
#| label: fig-frequency-female
#| fig-cap: "Comparative Analysis of Word Frequency in Female Stream of Consciousness Authors"
...
#| message: false
#| warning: false
#| label: fig-frequency-male
#| fig-cap: "Comparative Analysis of Word Frequency in Male Stream of Consciousness Authors"
...
## Combined Texts: Trends, Bigram and Trigram Analsis
...
#| label: fig-cloud
#| layout-ncol: 2
#| fig-cap: "Visualizations of Word Frequency when Combining Stream of Consciousness Authors' Novels"
#| fig-subcap: ["One Word"] #Add "Two Words" and "Three Words" subsequently when uncovering the trends for the previous one


filtered_text <- combined_text[combined_text$n >= 2, ] #only select words with a frequency larger or equal to 2

wordcloud(words = filtered_text$word, freq = filtered_text$n, scale=c(3,0.5), min.freq = 2, random.order = FALSE, colors=brewer.pal(8, "Dark2"))

#filtered_bigram <- combined_bigram[combined_bigram$n >= 2, ]
#wordcloud(words = filtered_bigram$word, freq = filtered_bigram$n, scale=c(3,0.5), min.freq = 2, random.order = #FALSE, colors=brewer.pal(8, "Dark2"))

#filtered_trigram <- combined_trigram[combined_trigram$n >= 2, ]
#wordcloud(words = filtered_trigram$word, freq = filtered_trigram$n, scale=c(3,0.5), min.freq = 2, random.order #= FALSE, colors=brewer.pal(8, "Dark2"))
